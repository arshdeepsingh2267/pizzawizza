    ...
    <header className="text-white-100 sticky top-0 z-50 bg-gradient-to-r from-indigo-700 via-violet-700 to-orange-700 body-font">
      <div className="container mx-auto  flex flex-wrap p-3 flex-col md:flex-row items-center">
        ...
        <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center">
          {/* <a className="text-white mr-5 cursor-pointer hover:text-gray-200">
            About
          </a> */}
          <Link
            href={"/cart"}
          ...
          {localStorage.getItem("token") ? (
            ...
            <>
              ...
              <Link
                href={"/signup"}
                className="text-white mr-5 cursor-pointer flex items-center hover:text-gray-200"
              >
                Signup{" "}
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          {/* <button className=" inline-flex bg-white rounded items-center dark:text-gray-900 m-0.5 p-1 ">
            Button
            <svg
              fill="none"
              stroke="currentColor"
