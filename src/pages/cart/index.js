    ...
    <>
      ...
      {fail && (
        ...
        >
          ...
          <span class="block sm:inline">Your order was cancelled 😔</span>
              ...
              <div class="overflow-hidden">
                {state.length > 0 ? (
                  <>
                    ...
                    <td
                      onClick={() => {}}
                      class="cursor-pointer whitespace-nowrap px-2 py-2 hover:text-neutral-500"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                  ...
                  <tr class="border-b dark:border-neutral-500">
                    ...
                    <div>
                      <button
                        className="border bg-gradient-to-r from-orange-700 via-violet-700 to-indigo-700 dark:bg-gradient-to-r from-orange-700 via-violet-700 to-indigo-700 dark:border-gray-400 border-gray-900 rounded p-2 hover:bg-gradient-to-r from-indigo-700 via-violet-700 to-orange-700  hover:text-gray-100 "
